...
#
# Generated by Vivado on Mon May 11 14:10:33 PDT 2026
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../ip/rtl"]" $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "trigger_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if { [get_files adc_mux.v] == "" } {
  import_files -quiet -fileset sources_1 /home/moller/cameron/MOLLER-RFSoC-MTS/boards/ip/rtl/adc_mux.v
}
if { [get_files add_tlast.v] == "" } {
  import_files -quiet -fileset sources_1 /home/moller/cameron/MOLLER-RFSoC-MTS/boards/ip/rtl/add_tlast.v
}
...
if { [get_files self_trigger.v] == "" } {
  import_files -quiet -fileset sources_1 /home/moller/cameron/MOLLER-RFSoC-MTS/boards/ip/rtl/self_trigger.v
}
...
# module references:
# adc_mux, add_tlast, fir_compiler_8chs, self_trigger, subsystem_timestamp
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 63 -to 0 ts
  ...
  # Create instance: adc_mux_0, and set properties
  set block_name adc_mux
  set block_cell_name adc_mux_0
  if { [catch {set adc_mux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adc_mux_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: add_tlast_0, and set properties
  set block_name add_tlast
  set block_cell_name add_tlast_0
  if { [catch {set add_tlast_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $add_tlast_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: self_trigger_0, and set properties
  set block_name self_trigger
  set block_cell_name self_trigger_0
  if { [catch {set self_trigger_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $self_trigger_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC_NCO_Freq00 {-1.4965} \
   CONFIG.ADC_NCO_Freq02 {-1.4965} \
   CONFIG.ADC_NCO_Freq20 {-1.4965} \
   CONFIG.ADC_NCO_Freq22 {-1.4965} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net adc_mux_0_M_AXIS [get_bd_intf_pins adc_mux_0/M_AXIS] [get_bd_intf_pins add_tlast_0/s_axis]
  connect_bd_intf_net -intf_net add_tlast_0_m_axis [get_bd_intf_pins add_tlast_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net self_trigger_0_m_axis [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins self_trigger_0/m_axis]
  ...
  connect_bd_net -net RFingressReset_peripheral_aresetn [get_bd_pins adc_mux_0/aresetn] [get_bd_pins add_tlast_0/aresetn] [get_bd_pins clocktreeMTS/ingress_aresetn] [get_bd_pins fir_compiler_8chs_0/aresetn] [get_bd_pins self_trigger_0/aresetn] [get_bd_pins usp_rf_data_converter_1/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/m1_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/m2_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/m3_axis_aresetn]
  connect_bd_net -net add_tlast_0_m_axis_tlast [get_bd_pins add_tlast_0/m_axis_tlast] [get_bd_pins self_trigger_0/s_tlast]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins adc_mux_0/aclk] [get_bd_pins add_tlast_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins fir_compiler_8chs_0/aclk] [get_bd_pins self_trigger_0/aclk] [get_bd_pins usp_rf_data_converter_1/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m2_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m3_axis_aclk]
  ...
  connect_bd_net -net clocktreeMTS_ts [get_bd_pins clocktreeMTS/ts] [get_bd_pins self_trigger_0/ts_in]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins control_interconnect/ARESETN] [get_bd_pins control_interconnect/M00_ARESETN] [get_bd_pins control_interconnect/M01_ARESETN] [get_bd_pins control_interconnect/M02_ARESETN] [get_bd_pins control_interconnect/M03_ARESETN] [get_bd_pins control_interconnect/M04_ARESETN] [get_bd_pins control_interconnect/M05_ARESETN] [get_bd_pins control_interconnect/S00_ARESETN] [get_bd_pins system_management_wiz_0/s_axi_aresetn] [get_bd_pins usp_rf_data_converter_1/s_axi_aresetn] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins add_tlast_0/words_per_packet] [get_bd_pins xlconstant_0/dout]
