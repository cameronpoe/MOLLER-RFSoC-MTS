...
module octet_signal_24bit_signed(
    ...
    signal_source_24bit_signed signal_0 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_0),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_1 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_1),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_2 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_2),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_3 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_3),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_4 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_4),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_5 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_5),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_6 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_6),
        .increment(increment),
    ...
    signal_source_24bit_signed signal_7 (
        .aclk(aclk),
        .aresetn(aresetn),
        .offset(offset_7),
        .increment(increment),
